...
Após a nova grelha interna, a medição confirmou novamente alinhamento exacto no viewport 1280×1100: Header inner `left: 256`, `width: 1024`, `padding-left: 32px`; Main `left: 256`, `width: 1024`, `padding-left: 32px`; Main inner `left: 288`; Header title `left: 288`; Page title `left: 288`. O eixo estrutural está agora matematicamente coincidente.
